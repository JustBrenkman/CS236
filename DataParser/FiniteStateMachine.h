...
public:
    ...
    private:
        ...
        void(Aa::*proccessFunc)(FiniteStateMachine<Ta, Va, Aa>* fsm, Ta t); // Function that is used to determmine the next state
    ...
    public:
        State(FiniteStateMachine<Ta, Va, Aa>* fsm, void(Aa::*proccFunc)(FiniteStateMachine<Ta, Va, Aa>* fsm, Ta t), Aa* a, bool isStateAccepting) {
...
public:
    ...
    State<T, V, A>* createState(void(A::*proccFunc)(FiniteStateMachine<T, V, A>* fsm, T t), A* a, bool isStateAccepting) {
